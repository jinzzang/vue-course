<template>
  ...
  <OneRoom :oneRoom="oneRoom" v-for="(oneRoom,i) in 원룸들" :key="i" @openModal="모달창열렸니=모달창열렸니"/>
...
import OneRoom from './OneRoom.vue';

import data from './oneroom.js';
export default {
  components: { DiscountOneRoom, ModalOneRoom ,OneRoom},
  name: 'App',
  data(){
    return {
      모달창열렸니 : false,
